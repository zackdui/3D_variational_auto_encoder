...
# Significant changes include: Removing most of the file and adding SelfAttentionND
# This file is therefore a modified version of the original MONAI file.
# -------------------------------------------------------------------------

from __future__ import annotations
from .segresnet_block import ResBlock, get_conv_layer, get_upsample_layer
